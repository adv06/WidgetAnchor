...
SYSTEM_PROMPT = (
    ...
    "- Icons: ONLY use lucide-react (import from 'lucide-react'). Valid icon names include: "
    ...
    "- NEVER invent icon names. If unsure, use a generic icon like Circle or Square.\n"
    "- Use DOUBLE QUOTES for all JavaScript strings containing apostrophes (e.g. \"Let's go\" not 'Let\\'s go')\n"
